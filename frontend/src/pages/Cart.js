           ...
           <div class="cart-item">
              <div class="row">
                  ...
                  <div class="col-4 col-lg-1 mt-4 mt-lg-0">
                      <i id="delete_cart_item" class="fa fa-trash btn btn-danger" onClick={()=>removeQty(item)}></i>
                  </div>
...
</Fragment> : (!complete ?<h2 className='mt-5'> Your Cart is Empty</h2> : <Fragment><h2 className='mt-5'>Order Complete !</h2><p>Your Order is Placed succesfull.</p></Fragment>)
}
